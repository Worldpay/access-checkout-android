...
internal const val SESSIONS_MEDIA_TYPE = "application/vnd.worldpay.sessions-v1.hal+json"
internal const val VERIFIED_TOKENS_MEDIA_TYPE = "application/vnd.worldpay.verified-tokens-v1.hal+json"
