...
import com.worldpay.access.checkout.MockServer.Paths.SESSIONS_PAYMENTS_CVC_PATH
import com.worldpay.access.checkout.MockServer.Paths.SESSIONS_ROOT_PATH
import com.worldpay.access.checkout.MockServer.stubFor
import com.worldpay.access.checkout.SessionsMockStub.SessionsResponses.defaultResponse
import com.worldpay.access.checkout.SessionsMockStub.SessionsResponses.validResponseWithDelay
    ...
    object SessionsResponses {
        ...
        fun validResponseWithDelay(context: Context, delay: Int): ResponseDefinitionBuilder? {
            return aResponse()
                ...
                .withBody(sessionsResourceResponse(context))
        }
